                                ...
                                <tr key={index} className="bg-white border-b hover:bg-gray-50">
                                    ...
                                    <td className="py-4 px-6 font-medium text-gray-900 whitespace-nowrap">
                                        <div className="flex items-center space-x-2">
                                            <button
                                                onClick={() => setClickedAddress(clickedAddress === point.address ? null : point.address)}
                                                className="text-blue-600 hover:text-blue-800 underline cursor-pointer"
                                                title="Click to show full address"
                                            >
                                                {clickedAddress === point.address ? point.address : truncateAddress(point.address)}
                                            </button>
                                            <button
                                            ...
                                            {copiedMessage[point.address] && <span className="text-xs text-green-500">Copied!</span>}
                                        </div>
                                    </td>
