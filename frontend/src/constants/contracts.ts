export const loyaltyPointAddress = process.env.REACT_APP_LOYALTY_POINT_ADDRESS || "0x...DEFAULT_CONTRACT_ADDRESS_HERE"; // TODO: Replace with your contract address or provide a default
...
export const employeeVestingABI = [
    {
      "inputs": [
        {
          "internalType": "address",
        ...
        {
          "internalType": "address",
          "name": "initialDistributorManager",
          "type": "address"
        },
        {
          "internalType": "address",
          "name": "amdTokenAddress",
          "type": "address"
        }
      ],
      "stateMutability": "nonpayable",
    ...
    },
    {
      ...
      "name": "getCurrentlyReleasableAmount",
      "outputs": [
        {
          "internalType": "uint256",
          "name": "",
...
export const founderVestingABI = [
    {
      "inputs": [
        {
          "internalType": "address",
...
export const investorVestingABI = [
    {
      "inputs": [
        {
          "internalType": "address",
